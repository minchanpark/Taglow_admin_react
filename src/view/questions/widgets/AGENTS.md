# questions Widgets Agent Guide

`src/view/questions/widgets`는 question editor의 form, image picker, preview UI를 둡니다.

## 책임

- `QuestionForm`, `QuestionImagePicker`, `QuestionPreviewPanel` 같은 presentational widget을 구현합니다.
